...
| image.agent | string | `"ghcr.io/cndoit18/lxcfs-agent:v0.2.4"` | lxcfs-on-kubernetes agent image |
| image.manager | string | `"ghcr.io/cndoit18/lxcfs-manager:v0.2.4"` | lxcfs-on-kubernetes controller image |
