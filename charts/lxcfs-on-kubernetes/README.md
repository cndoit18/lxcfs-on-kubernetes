...
|-----|------|---------|-------------|
| image.agent | string | `"ghcr.io/cndoit18/lxcfs-agent:v0.1.3"` | lxcfs-on-kubernetes agent image |
| image.manager | string | `"ghcr.io/cndoit18/lxcfs-manager:v0.1.3"` | lxcfs-on-kubernetes controller image |
